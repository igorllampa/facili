package br.com.facilitecommerce.api.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', "
				+ "que é de um tipo inválido. Informe um valor compatível com o tipo %s.",
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		String path = getPathOfProblemCause(ex.getPath());
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format("A propriedade '%s' recebeu o valor '%s' que é"
				+ " de um tipo inválido. Informe um valor compatível com o tipo %s.",
	...
	private String getPathOfProblemCause(List<Reference> path) {
		return path.stream()
